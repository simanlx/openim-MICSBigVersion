...
enum CustomSureShareDialogType {
  HZXQ, //患者详情
  YLBW, //医疗备忘
  OTHER, //医疗备忘
}

class CustomSureShareDialog extends StatelessWidget {
   CustomSureShareDialog({
    Key? key,
    this.checkList,
    this.checkGroupList,
    this.title = "",
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomCardWidget(type,title,content,height: 210.h,width: 220.w,timeStr: timeStr),
