...
class StrRes {
  ...
  static get hospitalizationStatus => 'hospitalizationStatus'.tr;

  static get wardStatus => 'wardStatus'.tr;

  static get age => 'age'.tr;

  static get patientManage => 'patientManage'.tr;

  static get commonApplications => 'commonApplications'.tr;

  static get myCollection => 'myCollection'.tr;

  static get noticeList => 'noticeList'.tr;

  static get knowledgeBaseSearch => 'knowledgeBaseSearch'.tr;

  static get medicalMemo => 'medicalMemo'.tr;
