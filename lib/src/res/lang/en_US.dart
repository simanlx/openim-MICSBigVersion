const Map<String, String> en_US = {
  'welcomeUse': 'Welcome to MICS',
  "welcomeHint": "MICS makes your data more secure",
  'phoneNum': "Phone",
  ...
  'pwdExplanation':
      'The login password is used to log in to the MICS account',
  ...
  "createGroupDescribe": "Create group chats and fully use MICS",
