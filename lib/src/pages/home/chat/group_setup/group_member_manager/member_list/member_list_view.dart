...
import 'package:mics_big_version/src/models/group_member_info.dart' as gm;
      ...
      body: SafeArea(
        child: Obx(() => Column(
              children: [
                ...
                Expanded(
                  child: WrapAzListView<gm.GroupMembersInfo>(
...
class _ConfirmView extends StatelessWidget {
  ...
  Widget _buildItemView(gm.GroupMembersInfo info) => Container(
        color: PageStyle.c_FFFFFF,
        height: 75.h,
        padding: EdgeInsets.symmetric(horizontal: 22.w),
        child: Row(
