...
class GroupMessageReadPage extends StatelessWidget {
  final logic = Get.find<GroupMessageReadLogic>();
    ...
    return Scaffold(
      ...
      body: Obx(() => Column(
            children: [
              _TabLayoutView(
                logic.index.value,
                readCount: logic.haveReadUserIDList.length,
                unreadCount: logic.unreadMemberList.length,
