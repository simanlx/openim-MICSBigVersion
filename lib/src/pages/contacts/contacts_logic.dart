...
import 'package:mics_big_version/src/pages/contacts/department_friend_list/depart_list_friend_logic.dart';
import 'package:mics_big_version/src/pages/contacts/frequent_contacts/frequent_contacts_logic.dart';
import 'package:mics_big_version/src/pages/contacts/frequent_contacts/frequent_contacts_view.dart';
import 'package:mics_big_version/src/pages/contacts/friend_info/friend_info_logic.dart';
import 'package:mics_big_version/src/pages/contacts/friend_info/friend_info_view.dart';
import 'package:mics_big_version/src/pages/contacts/friend_list/friend_list_view.dart';
...
class ContactsLogic extends GetxController {
  ...
  void onReady() {
    ...
    stackList.add(new MyFriendListPage());
    super.onReady();
  }
